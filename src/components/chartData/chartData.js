...
const ChartedData = (props) => {
   ...
   // const dates = props.dates;
    ...
    return (
        <>
           {(props.checkboxVars.checkedHighest || props.checkboxVars.checkedLowest || props.checkboxVars.checkedOpen || props.checkboxVars.checkedClosing || props.checkboxVars.checkedVolume) &&  <button className="grid-toggle-button" onClick={toggleGrid}>{gridBtnText}</button>}
